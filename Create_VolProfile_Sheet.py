...
I_495_Dat_EB_Off = I_495_Dat_EB_Off.drop(columns = [I_495_Dat_EB_Off.columns[0],I_495_Dat_EB_Off.columns[1]])
idx = I_495_Dat_EB_Off.columns.str.split('_', expand=True)
I_495_Dat_EB_Off.columns = idx
#****************************************************************************
I_495_Dat_EB_On = x1.parse('I-90 EB Onramp')
I_495_Dat_EB_On = I_495_Dat_EB_On.drop(columns = [I_495_Dat_EB_On.columns[0],I_495_Dat_EB_On.columns[1]])
...
mux = pd.MultiIndex.from_product([['Friday','Saturday','Sunday','Monday'],
                                  ['AET07-EB','I-90 EB Offramp-I495','I-90 EB Onramp-I495','EB Route 9 Off-Ramp','EB Route 9 On-Ramp','VSep']], names=['Day','Seg'])
...
EB_Dat.loc[1,idx[:,['AET07-EB','I-90 EB Offramp-I495','I-90 EB Onramp-I495','EB Route 9 Off-Ramp','EB Route 9 On-Ramp','VSep']]] = [1,3,5,14,16,-999]*4
...
I_495_Dat_WB_Off = I_495_Dat_WB_Off.drop(columns = [I_495_Dat_WB_Off.columns[0],I_495_Dat_WB_Off.columns[1]])
idx = I_495_Dat_WB_Off.columns.str.split('_', expand=True)
I_495_Dat_WB_Off.columns = idx
#****************************************************************************
I_495_Dat_WB_On = x1.parse('I-90 WB Onramp')
I_495_Dat_WB_On = I_495_Dat_WB_On.drop(columns = [I_495_Dat_WB_On.columns[0], I_495_Dat_WB_On.columns[1]])
...
mux = pd.MultiIndex.from_product([['Friday','Saturday','Sunday','Monday'],
                                  ['AET09-WB','WB Route 9 Off-Ramp','WB Route 9 On-Ramp','I-90 WB Offramp-I495','I-90 WB Onramp-I495','VSep']], names=['Day','Seg'])
...
WB_Dat.loc[1,idx[:,['AET09-WB','WB Route 9 Off-Ramp','WB Route 9 On-Ramp','I-90 WB Offramp-I495','I-90 WB Onramp-I495','VSep']]] = [1,5,7,16,18,-999]*4
