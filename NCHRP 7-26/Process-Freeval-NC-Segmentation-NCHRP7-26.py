...
os.chdir(
    r"C:\Users\abibeka\OneDrive - Kittelson & Associates, Inc\Documents\NCHRP7-26\Data\SegDatabaseNC"
)
...
Dat.rename(
    columns={
        "General Purpose Segment Type": "segType",
        "Segment Length (ft)": "segLenFt",
        "# of Lanes: Mainline": "segNumLanes",
        "Acc/Dec Lane Length (ft)": "segAccDecLen",
        "ONR Side": "segOnrSide",
        "# Lanes: ONR": "segOnrNumLanes",
        "OFR Side": "segOfrSide",
        "# Lanes: OFR": "segOfrNumLanes",
    },
    inplace=True,
)
